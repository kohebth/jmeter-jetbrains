...
public final class JMeterTreeLoader {
    private JMeterTreeLoader() {
    }

    public static JMeterTreeModel load(File file) throws IOException {
    ...
    public static HashTree toHashTree(JMeterTreeModel model) {
        return toHashTree(model, false);
    }

    public static HashTree toRunHashTree(JMeterTreeModel model) {
    ...
    public static HashTree toHashTree(JMeterTreeNode node) {
        HashTree tree = new ListedHashTree();
