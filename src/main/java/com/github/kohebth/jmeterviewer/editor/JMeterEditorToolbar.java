...
import com.github.kohebth.jmeterviewer.ui.JMeterIconButtons;
...
public final class JMeterEditorToolbar {
    private JMeterEditorToolbar() {
    }

    public static JComponent create(JMeterEditorToolbarState state) {
