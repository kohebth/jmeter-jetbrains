...
import com.github.kohebth.jmeterviewer.palette.JMeterAddElementDialog;
import com.github.kohebth.jmeterviewer.results.JMeterNativeResultView;
...
public final class JMeterVisualModelInstaller {
    private JMeterVisualModelInstaller() {
    }

    public static Installed install(Project project,
    ...
    public static final class Installed {
        ...
        public JMeterTreeActions treeActions() {
            return treeActions;
        }

        public JMeterCommandPalette commandPalette() {
            return commandPalette;
        }

        public JMeterTemplateDialog templateDialog() {
