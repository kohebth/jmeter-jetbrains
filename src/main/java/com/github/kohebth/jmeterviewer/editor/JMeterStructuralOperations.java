...
public final class JMeterStructuralOperations {
    private JMeterStructuralOperations() {
    }

    public static JMeterTreeNode insertParent(JMeterTreeModel model,
    ...
    public static JMeterTreeNode changeParent(JMeterTreeModel model, JMeterTreeNode node, JMeterPaletteItem controller) {
    ...
    public static int addThinkTimes(JMeterTreeModel model, JMeterTreeNode parent) {
