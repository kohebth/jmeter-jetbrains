...
public final class JMeterTemplate {
    ...
    public static JMeterTemplate custom(String name, String description, java.util.List<Node> roots) {
        return new JMeterTemplate(name, description, true, null, roots);
    }

    public static JMeterTemplate nativeTemplate(org.apache.jmeter.gui.action.template.Template template) {
    ...
    public static java.util.List<JMeterTemplate> defaults() {
    ...
    public boolean nativeTemplate() {
        return nativeTemplate != null;
    }

    public org.apache.jmeter.gui.action.template.Template nativeDefinition() {
    ...
    public static Node node(String element, java.util.List<Node> children) {
