...
public final class JMeterTemplateInsertion {
    private JMeterTemplateInsertion() {
    }

    public static JMeterTreeNode parent(JMeterTreeModel model, JMeterTreeNode selected, JMeterTemplate.Node template) {
