...
import com.github.kohebth.jmeterviewer.editor.JMeterTreeSnapshot;
...
public final class JMeterIdeUndoSupport {
    private final Project project;
    private final VirtualFile file;
    private final Consumer<JMeterTreeModel> restorer;
    private JMeterTreeSnapshot current;

    public JMeterIdeUndoSupport(Project project, VirtualFile file, Consumer<JMeterTreeModel> restorer) {
        this.project = project;
        this.file = file;
        this.restorer = restorer;
    }

    public void reset(JMeterTreeModel model) {
        current = JMeterTreeSnapshot.capture(model);
    }

    public void record(JMeterTreeModel model) {
