...
public final class JMeterSampleResultExporter {
    private JMeterSampleResultExporter() {
    }

    public static void csv(JMeterSampleResultTableModel model, File file) throws IOException {
    ...
    public static void jtlXml(JMeterSampleResultTableModel model, File file) throws IOException {
        try (Writer writer = new OutputStreamWriter(new FileOutputStream(file), StandardCharsets.UTF_8)) {
    ...
    public static void jtlCsv(JMeterSampleResultTableModel model, File file) throws IOException {
        try (Writer writer = new OutputStreamWriter(new FileOutputStream(file), StandardCharsets.UTF_8)) {
    ...
    private interface SampleWriter {
        public void write(SampleResult result) throws IOException;
    }
}
