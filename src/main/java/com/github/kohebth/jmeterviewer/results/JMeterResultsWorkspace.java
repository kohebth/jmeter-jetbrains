...
public final class JMeterResultsWorkspace {
    ...
    public static JMeterResultsWorkspace get(Project project) {
        return project.getService(JMeterResultsWorkspace.class);
    }

    public JMeterResultsPanel resultsPanel() {
        return resultsPanel;
    }

    public JComponent runControlsComponent() {
        return runControlsPanel;
    }

    public void setRunControls(Object owner,
    ...
    public void clearRunControls(Object owner) {
    ...
    public void installContents(ToolWindow toolWindow,
    ...
    public void updateNativeResultViews(EnumSet<JMeterNativeResultView> views) {
    ...
    public void showViewResultsTree() {
    ...
    public void showNativeView(JMeterNativeResultView view) {
    ...
    public static ContentSpec content(String title, Icon icon, JComponent component) {
