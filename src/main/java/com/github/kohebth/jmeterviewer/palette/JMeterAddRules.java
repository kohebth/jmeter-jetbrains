...
public final class JMeterAddRules {
    ...
    public static TestElement createAddableElement(JMeterTreeNode parent, JMeterPaletteItem item) {
        if (parent == null || item == null) {
            return null;
        }
        try {
    ...
    public static boolean canAddElement(JMeterTreeNode parent, TestElement element) {
