...
public final class JMeterPropertiesFileActions {
    private JMeterPropertiesFileActions() {
    }

    public static void importProperties(Project project, Runnable afterImport) {
    ...
    public static void exportProperties(Project project) {
    ...
    public static void copySelected(java.util.List<String> selected) {
