...
import com.github.kohebth.jmeterviewer.run.JMeterRunProfile;
...
public final class JMeterAdvancedRunOptions {
    ...
    public JMeterAdvancedRunOptions(Project project) {
    ...
    public JMeterRunProfile.Advanced snapshot() {
    ...
    public void restore(JMeterRunProfile.Advanced profile) {
