...
public final class JMeterTemplateStore implements PersistentStateComponent<JMeterTemplateStore.State> {
    ...
    static JMeterTemplateStore get(Project project) {
    ...
    java.util.List<JMeterTemplate> templates() {
    ...
    void save(String name, String description, java.util.List<JMeterTemplate.Node> roots) {
        delete(name);
